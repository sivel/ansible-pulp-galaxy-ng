...
def delete_galaxy_namespace(namespace, module):
    ...
    ns_uri = '%s/api/galaxy/v3/namespaces/%s/' % (module.params['galaxy_api'], namespace)
...
def get_galaxy_namespaces(module):
    ...
    namespace_uri = module.params['galaxy_api'] + '/api/galaxy/v3/namespaces/?limit=100&offset=0'
...
def new_galaxy_namespace(name, module):
    ...
    ns_uri = module.params['galaxy_api'] + '/api/galaxy/v3/namespaces/'
...
def main():
    module_args = dict(
        ...
        galaxy_api=dict(type='str', required=True),
